...
<html>
  ...
  <body>
    ...
    <header class="site-header js-site-header">
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-4 col-md-4 text-center"><a href="/en"><img src="images/logoNaman.png" class="img-fluid"></a></div>
          <div class="col-4 col-md-4 site-logo" data-aos="fade">
            <button type="button" class="btn btn-transparent book-size">BOOK NOW</button>
          </div>
        </div>
      </div>
    </header>
    ...
    <section class="site-hero overlay"  data-stellar-background-ratio="0.5">
      <div class="swiper-slide" style="background-image:url('images/home_page_1.png');">
        <video autoplay="" muted="" loop="" playsinline="" class="backgroundVideo" poster="images/home_page_1.png">
    ...
    <section class="section blog-post-entry bg-light">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
            <h1 class="heading fs-0 text-futura aos-init aos-animate" data-aos="fade-up">RETREAT AT NAMAN</h1>
          </div>
        </div>
        <div class="row">
